...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            setupUserInfo()
            setupListeners()
            setupNavigationCards() // NUEVA FUNCIÓN AGREGADA
            setupRecentActivity()
    ...
    private fun loadUserProfileImage() {
        ...
        Glide.with(this)
            ...
            .circleCrop()
            .into(ivUserProfile) // Cambiado a ivUserProfile en lugar de btnProfile
    }
    ...
    // NUEVA FUNCIÓN: Configurar tarjetas de navegación
